...
@EnableJpaRepositories("za.ac.nwu.dp.repo")
...
public class RepositoryConfig{
    ...
    private Properties buildJpaProperties(){
        ...
        properties.setProperty("hibernate.transaction.factory_class","org.hibernate.hql.internal.classic.ClassicQueryTranslatorFactory");
